...
ROOT=Path('/home/ubuntu/ga-em-dm-resource-hub'); DATA=ROOT/'client/src/data'; AUDIT=ROOT/'research/australia_amt_enrichment_local_audit.csv'; OUT=DATA/'australia_amt_enrichment_verified_resources.csv'
