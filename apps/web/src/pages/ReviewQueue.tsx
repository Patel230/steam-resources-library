...
export default function ReviewQueue() {
  ...
  if (!isAuthenticated) return <main className="review-page review-page--gate"><section><ShieldCheck size={32} /><p className="eyebrow">STEAM Foundry / reviewer desk</p><h1>Sign in to open<br /><em>the review queue.</em></h1><p>Community contact details and moderation decisions are visible only to the archive owner.</p><button type="button" onClick={startLogin}>Sign in securely</button><a href="/">Return to the public archive <ArrowLeft size={15} /></a></section></main>;

  if (!isAdmin) return <main className="review-page review-page--gate"><section><ShieldCheck size={32} /><p className="eyebrow">STEAM Foundry / access boundary</p><h1>This desk is<br /><em>owner-restricted.</em></h1><p>The public archive remains available, but submitted source leads and reviewer notes are private.</p><a href="/">Return to the public archive <ArrowLeft size={15} /></a></section></main>;

  return <div className="review-page">
    <header className="review-page__header"><a className="brand-lockup" href="/" aria-label="STEAM Foundry home"><img src="/steam-foundry-mark.svg" alt="" className="brand-mark" /><span><strong>STEAM</strong> Foundry</span></a><nav aria-label="Review navigation"><a href="/">Public archive</a><a href="/coverage">Coverage ledger</a></nav><span><ShieldCheck size={15} /> Owner review desk</span></header>
